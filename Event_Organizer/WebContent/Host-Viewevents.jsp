        ...
        <div class="navigation ">
          <nav>
            <ul class="sf-menu">
             ...
             <li  class="current"><a href="Host-Viewevents.jsp">View-Events</a></li>
...
String query = "select * from event where host_id="+userid;
...
%>
  ...
  <td><%out.print(i); %></td>
    ...
    <td><a href="Delete.jsp?id=<%=rs.getInt("event_id") %>"><label>Delete</label></a></td>
