...
out.println("<h4 align='center'>Previous EventBookings</h4>");
		...
		out.print("<tr><th>Booking_ID</th><th>Event_ID</th><th>Event_Name</th><th>Event_Type</th><th>Event_Place</th><th>HostID</th><th>UserID</th> <th>NumberOfPeople</th> <th>Advance Paid</th> <th>Toala price</th></tr>");
		//for(Emp e:list){
