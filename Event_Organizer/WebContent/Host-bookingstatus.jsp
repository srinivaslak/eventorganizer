      ...
      <div class="grid_12">
        ...
        <div class="navigation ">
          <nav>
            ...
            <li class="current"><a href="Host-bookingstatus.jsp">EventBooking-Status</a></li>
...
out.println("<h4 align='center'>Previous EventBookings</h4>");
				...
				String query1="select * from event where eventtype="+search;
				      ...
				      pstmt = connection.prepareStatement("select * from userrequest where host_id=?"); // create a statement
		...
		out.print("<tr><th>Booking_ID</th><th>Event_ID</th><th>Event_Name</th><th>Event_Type</th><th>Event_Place</th><th>HostID</th><th>UserID</th> <th>NumberOfPeople</th> <th>Advance Paid</th> <th>Toala price</th><th>Request status</th><th>Cancle Status</th><th>Accept</th></tr>");
		//for(Emp e:list){
		...
		<td><%=rs.getInt("req_id") %></td>
		  <td><%=rs.getInt("reg_eventid") %></td>
		    ...
		    <td><a href="Accept.jsp?id=<%=eid%>">Accept</a></td>
