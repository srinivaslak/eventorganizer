        ...
        <div class="navigation ">
         <nav>
            <ul class="sf-menu">
             ...
             <li class="current"><a href="View-users.jsp">View-User</a></li>
...
//String query = "select * from registration where usertype=`host`";
      ...
      pstmt = connection.prepareStatement("select * from registration where usertype='user'"); // create a statement
