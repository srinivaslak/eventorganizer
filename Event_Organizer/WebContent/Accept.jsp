...
//String query = "select * from registration where usertype=`host`";
      ...
      pstmt = connection.prepareStatement("update userrequest SET req_status=? where req_id=?");
      pstmt.setString(1, cs);
      pstmt.setInt(2, id);
		int row = pstmt.executeUpdate();
	if (row > 0) {
    
               request.setAttribute("success", "User Booking Accepted successfully");
      
             
                RequestDispatcher rd1 = request.getRequestDispatcher("/Host-bookingstatus.jsp");
